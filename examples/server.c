...
int main(int argc, char** argv) {
    ...
    UA_Server_addVariableNode_begin(server, UA_NODEID_NULL, UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                        UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), dateName,
                                        v_attr, &dataSourceId);
    /* Set the data source */
    UA_Server_setVariableNode_dataSource(server, dataSourceId, dateDataSource);
    UA_Server_addVariableNode_finish(server, dataSourceId, UA_NODEID_NULL, NULL);
